...
export const ICONS = {
  ...
  Ticket: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 9V5a2 2 0 0 1 2-2h3v2a2 2 0 0 1-2 2v2a2 2 0 0 1 2 2v2H5a2 2 0 0 1-2-2v-4z"/><path d="M21 9V5a2 2 0 0 0-2-2h-3v2a2 2 0 0 0 2 2v2a2 2 0 0 0-2 2v2h3a2 2 0 0 0 2-2v-4z"/><line x1="13" y1="5" x2="13" y2="19"/><line x1="11" y1="5" x2="11" y2="19"/></svg>
  ),
  Search: (props: any) => (
